...
def check_narration_with_gemini(narration_blocks, api_key):
    ...
    try:
        ...
        2. 芸能人の名前の漢字間違いも指摘してください
        3. テレビは子どもも見るので難しすぎる漢字は避けたいです
        4. 半角と全角の違い（数字・記号・英字）は誤りとして扱わないでください
        5. テレビのナレーションなので超厳密なチェックではなく、これ絶対間違ってるよね？という所だけ指摘して下さい
        6. 指摘は分かりやすく簡潔に。
        7. タイムが前後したり同じような文章が続いていたりする場合も指摘を
